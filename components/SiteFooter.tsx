...
export const WHATSAPP_SOPORTE = `https://wa.me/52${WHATSAPP}`;

/** Enlace a nuestro WhatsApp con un mensaje ya escrito. */
export function whatsappConMensaje(mensaje: string) {
  return `${WHATSAPP_SOPORTE}?text=${encodeURIComponent(mensaje)}`;
}
...
const redes = [
  ...
  {
    nombre: "WhatsApp",
    href: whatsappConMensaje("Hola, quiero información sobre el menú digital para mi negocio."),
    Icon: WhatsappIcon,
  },
];
      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-5">
        ...
        <div className="text-center">
          <p className="text-xs font-bold text-foreground/60">
            Mi Menú <span className="font-medium text-foreground/40">by De Cd Hidalgo Pal Mundo</span>
          </p>
